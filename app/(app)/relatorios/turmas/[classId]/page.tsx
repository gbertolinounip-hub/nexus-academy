  ...
  return (
    <div className="stack reports-dashboard class-final-report">
      ...
      {report ? (
          ...
          <SectionCard
            ...
            actions={
              <Link href={backHref} className="button button-secondary">
                {origin === "audit" ? "Voltar à auditoria" : "Voltar aos relatórios"}
              </Link>
            }
          >
            ...
            >
              {report.supervisors.length ? (
                ...
                <p className="empty-message">
                  Nenhum supervisor foi identificado para esta turma no recorte
                  selecionado.
                </p>
              )}
            </SectionCard>
        ...
        >
          <p className="empty-message">
            Quando houver turma, matrículas, lançamentos e faltas consistentes
            no banco, este fechamento será exibido aqui.
          </p>
        </SectionCard>
      )}
    </div>
