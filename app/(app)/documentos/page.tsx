...
export default async function StudentDocumentsPage() {
  ...
  const rejectedCount = [...pageData.vaccinationHistory, ...pageData.tceDocuments].filter(
  ...
  return (
    <div className="stack student-documents-page">
      <section className="hero-card">
        ...
        <p>
          Envie sua carteira de vacinação e os TCEs vinculados às áreas operacionais
          do estágio. Os arquivos ficam em storage privado e podem ser revisados
          por professor supervisor e coordenação.
        </p>
      </section>
