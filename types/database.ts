    ...
    Tables: {
      ...
      configuracoes_tce_estagio: {
        Row: {
          ...
          nome: string;
          ativo: boolean;
          dados_concedente: Record<string, unknown>;
          dados_vigencia: Record<string, unknown>;
          dados_horario: Record<string, unknown>;
          jornada_diaria: string | null;
          jornada_semanal: string | null;
          jornada_semestral: string | null;
          plano_atividades: string | null;
      ...
      tces_aluno: {
        Row: {
          id: string;
          configuracao_tce_estagio_id: string;
          aluno_id: string;
          matricula_turma_id: string | null;
          area_estagio_id: string | null;
          dados_estagiario: Record<string, unknown>;
          configuracao_snapshot: Record<string, unknown>;
